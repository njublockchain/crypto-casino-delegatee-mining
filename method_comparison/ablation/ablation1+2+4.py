...
# Step 5: Self-Supervised Loss (SSL)
...
for epoch in range(200):
    ...
    # Output clusters for SSL loss calculation
    clusters = {}
    ...
    # Combine Losses
    final_loss = gat_loss + lstm_loss + ssl_loss_value
...
nx.write_gexf(G, '/home/lab0/gnn-wjx/0xc2a81eb482cb4677136d8812cc6db6e0cb580883_ablation124_all_cluster_best_loss.gexf')
